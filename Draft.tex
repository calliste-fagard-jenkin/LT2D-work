...
\usepackage{multicol,graphicx,float,tikz,tikz-qtree,scrextend}
\usepackage[margin=1 in]{geometry}
\title{A Method for Analysing Heterogeneous Population Data with 2D Detection Function Distance Sampling}
\date{January 2018}
...
\subsection{Covariate implementation}
\section{Usage of the new sofware}
